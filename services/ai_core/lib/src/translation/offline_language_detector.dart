...
class OfflineLanguageDetector implements LanguageDetectionProvider {
  ...
  static const Map<String, List<String>> _latinProfiles = {
    'en': ['the', 'be', 'to', 'of', 'and', 'a', 'in', 'that', 'have', 'i', 'it', 'for', 'not', 'on', 'with', 'he', 'as', 'you', 'do', 'at', 'this', 'but', 'his', 'by', 'from', 'they', 'we', 'say', 'her', 'she', 'or', 'an', 'will', 'my', 'one', 'all', 'would', 'there', 'their', 'what', 'so', 'up', 'out', 'if', 'about', 'who', 'get', 'which', 'go', 'me', 'hello', 'how', 'are'],
    'es': ['de', 'la', 'que', 'el', 'en', 'y', 'a', 'los', 'del', 'se', 'las', 'por', 'un', 'para', 'con', 'no', 'una', 'su', 'al', 'lo', 'como', 'más', 'pero', 'sus', 'le', 'ya', 'o', 'este', 'sí', 'porque', 'esta', 'son', 'entre', 'está', 'cuando', 'muy', 'sin', 'sobre', 'ser', 'hola', 'cómo', 'estás', 'gracias', 'bien'],
    'fr': ['de', 'la', 'le', 'et', 'les', 'des', 'en', 'un', 'du', 'une', 'que', 'est', 'pour', 'qui', 'dans', 'a', 'par', 'plus', 'pas', 'au', 'sur', 'ne', 'se', 'ce', 'il', 'sont', 'avec', 'tout', 'faire', 'son', 'nous', 'bonjour', 'comment', 'allez', 'vous', 'merci'],
    'de': ['der', 'die', 'und', 'in', 'den', 'von', 'zu', 'das', 'mit', 'sich', 'des', 'auf', 'für', 'ist', 'im', 'dem', 'nicht', 'ein', 'eine', 'als', 'auch', 'es', 'an', 'werden', 'aus', 'er', 'hat', 'dass', 'sie', 'nach', 'wird', 'bei', 'einer', 'hallo', 'wie', 'geht', 'danke'],
    'pt': ['de', 'a', 'o', 'que', 'e', 'do', 'da', 'em', 'um', 'para', 'é', 'com', 'não', 'uma', 'os', 'no', 'se', 'na', 'por', 'mais', 'as', 'dos', 'como', 'mas', 'foi', 'ao', 'ele', 'das', 'tem', 'à', 'seu', 'sua', 'ou', 'ser', 'olá', 'como', 'está', 'obrigado'],
    'it': ['di', 'e', 'il', 'la', 'che', 'in', 'a', 'per', 'un', 'del', 'della', 'dei', 'delle', 'le', 'si', 'non', 'da', 'con', 'sono', 'una', 'nel', 'come', 'anche', 'più', 'questo', 'questa', 'ciao', 'come', 'stai', 'grazie'],
  };
  ...
  Future<LanguageDetectionResult> detectLanguage(String text) async {
    ...
    final scores = <String, int>{'en': 0, 'es': 0, 'fr': 0, 'de': 0, 'pt': 0, 'it': 0};
    ...
    scores.forEach((lang, score) {
      ...
      alternatives.add({'language': lang, 'confidence': double.parse(conf.toStringAsFixed(2))});
      if (score > maxScore) {
        maxScore = score;
        topLang = lang;
      }
